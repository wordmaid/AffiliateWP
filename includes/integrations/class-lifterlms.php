		...
		if ( version_compare( LLMS()->version, '3.0.0', '>=' ) ) {
			...
			<div class="llms-metabox-section d-all">
				...
				<div class="llms-metabox-field d-1of4">
					...
					<?php echo affwp_admin_link( 'referrals', $affiliate_name, array(), array( 'affiliate_id' => $referral->affiliate_id ) ); ?>
				</div>

				<div class="llms-metabox-field d-1of4">
					<label><?php _e( 'Reference', 'affiliate-wp' ); ?></label>
					<?php echo affwp_admin_link( 'referrals', $referral->referral_id, array(), array('action' => 'edit_referral', 'referral_id' => $referral->referral_id ) ); ?>
				</div>
					...
					<td>
						<table class="form-table">
							...
							<tr>
								...
								<td><?php echo affwp_admin_link( 'referrals', $affiliate_name, array(), array( 'affiliate_id' => $referral->affiliate_id ) ); ?></td>
							</tr>
							<tr>
								<td><label><?php _e( 'Reference', 'affiliate-wp' ); ?></label></td>
								<td><?php echo affwp_admin_link( 'referrals', $referral->referral_id, array(), array( 'action' => 'edit_referral', 'referral_id' => $referral->referral_id ) ); ?></td>
							</tr>
						</table>
					</td>
				</tr>
